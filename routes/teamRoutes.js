...
const { createTeam, joinTeam, inviteTeammate, removeTeammate, inscriptionTournament } = require('../controllers/teamController')
...
router.patch('/add-team/:idTeam/:idTournament', authMiddleware, inscriptionTournament)
